...
enum MAV_DATA_STREAM
{
	...
	MAV_DATA_STREAM_RAW_IMU=1, /* Enable IMU_RAW packets. | */
	MAV_DATA_STREAM_RAW_GPS=2, /* Enable GPS_RAW packets. | */
	MAV_DATA_STREAM_RAW_GPS_STATUS=3, /* Enable GPS_STATUS packets. | */
	MAV_DATA_STREAM_EXTENDED_STATUS=4, /* Enable GPS_STATUS, CONTROL_STATUS, AUX_STATUS | */
	MAV_DATA_STREAM_RC_CHANNELS=5, /* Enable RC_CHANNELS_SCALED, RC_CHANNELS_RAW, SERVO_OUTPUT_RAW | */
	MAV_DATA_STREAM_RAW_CONTROLLER=6, /* Enable ATTITUDE_CONTROLLER_OUTPUT, POSITION_CONTROLLER_OUTPUT, NAV_CONTROLLER_OUTPUT. | */
	MAV_DATA_STREAM_POSITION=7, /* Enable LOCAL_POSITION, GLOBAL_POSITION/GLOBAL_POSITION_INT messages. | */
