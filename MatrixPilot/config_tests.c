...
#if (ANALOG_VOLTAGE2_INPUT_CHANNEL > NUM_ANALOG_INPUTS)
//	#error("ANALOG_VOLTAGE2_INPUT_CHANNEL > NUM_ANALOG_INPUTS.")
#endif
...
#endif
#if ((AIRFRAME_TYPE != AIRFRAME_STANDARD) && (ALTITUDEHOLD_STABILIZED == AH_FULL_ELEV))
    #error("ALTITUDEHOLD_STABILIZED set to AH_FULL_ELEV only supported for AIRFRAME_TYPE set to AIRFRAME_STANDARD")
#endif
