...
#define MAVLINK_RATE_POSITION               0   // LOCAL_POSITION, GLOBAL_POSITION/GLOBAL_POSITION_INT messages. |
...
#define MAVLINK_RATE_SUE                   40   // SERIAL_UDB_EXTRA data rate on channel EXTRA1
#define MAVLINK_RATE_FORCE                  0   // Send FORCE on plane (Aerodynamic force)
