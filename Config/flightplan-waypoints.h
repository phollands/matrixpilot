...
const struct waypointDef waypoints[] = {
	...
	{ { -10942177, 514757863, 30 } , F_NORMAL + F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 2
	...
	{ { -10946437, 514775941, 1 } , F_NORMAL + F_ABSOLUTE + F_CROSS_TRACK + F_ALTITUDE_AGL + F_LAND , CAM_VIEW_LAUNCH } , //Waypoint 17
