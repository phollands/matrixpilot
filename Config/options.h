...
#define ID_VEHICLE_MODEL_NAME "Easy Star in HILSIM"
#define ID_VEHICLE_REGISTRATION "AA-PDH-UK-UDB5"
#define ID_LEAD_PILOT "Pete Hollands"
#define ID_DIY_DRONES_URL "https://github.com/MatrixPilot"
